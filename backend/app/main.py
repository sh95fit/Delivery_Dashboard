...
from app.database import rds_ok, get_dash_engine
from app.auth import (
    oauth, is_allowed_email, is_admin_email,
    get_current_email, set_session_cookie,
)

app = FastAPI(title="Delivery Dashboard API", version="0.3.0")
app.add_middleware(
    SessionMiddleware,
...
# --- 로그인 (외부 주소는 /api/auth/* — Nginx가 /api 접두사를 벗겨 /auth/*로 전달) ---
@app.get("/auth/login")
